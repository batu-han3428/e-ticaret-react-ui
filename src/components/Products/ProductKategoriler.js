        ...
        <div className="col-md-3" id="kategoriMenusu">
            <div className="accordion" style={{ backgroundColor: "white" }}>
                <div className="border-bottom p-3">
                    <h1 className="h4">Telefon Fiyatları ve Modelleri</h1>
                </div>
                ...
                <div className="accordion-item">
                    <h2 className="accordion-header">
                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#stok">
                            <Icon.BinocularsFill className="categoriesIcon" /><span>STOK</span>
                        </button>
                    </h2>
                ...
                <div className="p-3">
                    <h1 className="h6">Telefon</h1>
                    <p className="kategoriAltYazi">Hem en uygun fiyatlı hem son teknoloji telefon modelleri Teknosa'da! Telefon fiyatlarını ve telefon özelliklerini karşılaştırın, kullanıcı yorumlarını okuyun ve Teknosa güvencesiyle satın alın. Aradığınız telefon sizi bekliyor!</p>
                </div>
            </div>
        </div>
        )
